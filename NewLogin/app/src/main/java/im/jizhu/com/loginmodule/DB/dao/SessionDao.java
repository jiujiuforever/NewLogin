...
public class SessionDao extends AbstractDao<SessionEntity, Long> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Session' (" + //
                ...
                "'UPDATED' INTEGER NOT NULL ," + // 9: created
...
/*public static void updateSessionState(SQLiteDatabase db,SessionEntity sessionEntity,int state){
    //db.delete(TABLENAME, "_id=?", new String[]{"" + sessionEntity.getId()});
    ContentValues contentValues=new ContentValues();
    contentValues.put("STATE",state);
    db.update(TABLENAME,contentValues,"_id=?",new String[]{sessionEntity.getId()+ ""});
    db.close();
}*/
    /**
     * @inheritdoc
