...
public class SessionEntity {
    ...
    private int created;
    private int updated;
    private int state;//0表示消息正常，1表示最后一条消息是被撤回的，2表示正在发送中，3发送失败
    ...
    public SessionEntity(Long id, String sessionKey, int peerId, int peerType, int latestMsgType, int latestMsgId, String latestMsgData, int talkId, int created, int updated,int state) {
        this.id = id;
