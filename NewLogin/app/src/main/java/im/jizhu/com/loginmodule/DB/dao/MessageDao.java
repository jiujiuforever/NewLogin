...
public class MessageDao extends AbstractDao<MessageEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property statusType = new Property(11, int.class, "statusType", false, "STATUS_TYPE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Message' (" + //
                ...
                "'UPDATED' INTEGER NOT NULL ,"+ // 10: created
                "'STATUS_TYPE' INTEGER NOT NULL ,"+  // 11: updated
    ...
    protected void bindValues(SQLiteStatement stmt, MessageEntity entity) {
        ...
        stmt.bindLong(12, entity.getStatusType());
    ...
    public MessageEntity readEntity(Cursor cursor, int offset) {
        MessageEntity entity = new MessageEntity( //
                ...
                cursor.getInt(offset + 11),// status_type
                cursor.getInt(offset + 12)// read_status
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, MessageEntity entity, int offset) {
        ...
        entity.setStatusType(cursor.getInt(offset + 11));
   ...
   /* *//**
     * 修改单个消息的状态（0表示正常，1表示回撤）
     *
     * @param messageEntity
     *//*
    public static void  updateMessageStateType(SQLiteDatabase db,MessageEntity messageEntity) {
        ContentValues contentValues=new ContentValues();
        contentValues.put("STATE_TYPE",1);
        db.update(TABLENAME,contentValues,"MSG_ID=?",new String[]{messageEntity.getMsgId()+""});
        //db.close();
    }*/
     ...
     * @param messageEntity
     *//*
    public static void  updateMessageReadStatus(SQLiteDatabase db,MessageEntity messageEntity) {

       ContentValues contentValues=new ContentValues();
        contentValues.put("READ_STATUS",1);
        db.update(TABLENAME,contentValues,"TO_ID=?",new String[]{messageEntity.getFromId()+""});
        //db.close();
    }
*/
    /**
