...
public class GroupDao extends AbstractDao<GroupEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StatuValue = new Property(10, int.class, "statuValue", false, "STATUVALUE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'GroupInfo' (" + //
                ...
                "'STATUVALUE' INTEGER NOT NULL ," + // 10: STATUVALUE
    ...
    public static void deleteData(SQLiteDatabase db,String gourpId) {
        String sql = "DELETE FROM GroupInfo WHERE PEER_ID="+gourpId;
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, GroupEntity entity) {
        ...
        stmt.bindLong(11, entity.getStatuValue());
    ...
    public GroupEntity readEntity(Cursor cursor, int offset) {
        GroupEntity entity = new GroupEntity( //
            ...
            cursor.getInt(offset + 10), // statuValue
    ...
    public void readEntity(Cursor cursor, GroupEntity entity, int offset) {
        ...
        entity.setStatuValue(cursor.getInt(offset+10));
