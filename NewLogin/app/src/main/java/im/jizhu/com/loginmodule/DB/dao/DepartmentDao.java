...
public class DepartmentDao extends AbstractDao<DepartmentEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ParentDepartId = new Property(3, int.class, "parentDepartId", false, "PARENT_DEPART_ID");
        ...
        public final static Property Created = new Property(6, int.class, "created", false, "CREATED");
        public final static Property Updated = new Property(7, int.class, "updated", false, "UPDATED");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'Department' (" + //
                ...
                "'PARENT_DEPART_ID' INTEGER NOT NULL ," + // 3: parentDepartId
                "'PRIORITY' INTEGER NOT NULL ," + // 4: priority
                "'STATUS' INTEGER NOT NULL ," + // 5: status
                "'CREATED' INTEGER NOT NULL ," + // 6: created
                "'UPDATED' INTEGER NOT NULL ," +// 7: updated
    ...
    protected void bindValues(SQLiteStatement stmt, DepartmentEntity entity) {
        ...
        stmt.bindLong(4, entity.getParentDepartId());
    ...
    public DepartmentEntity readEntity(Cursor cursor, int offset) {
        DepartmentEntity entity = new DepartmentEntity( //
            ...
            cursor.getInt(offset + 3), // parentDepartId
            cursor.getInt(offset + 4), // priority
            cursor.getInt(offset + 5), // status
            cursor.getInt(offset + 6), // created
    ...
    public void readEntity(Cursor cursor, DepartmentEntity entity, int offset) {
        ...
        entity.setParentDepartId(cursor.getInt(offset + 3));
        entity.setPriority(cursor.getInt(offset + 4));
        entity.setStatus(cursor.getInt(offset + 5));
        entity.setCreated(cursor.getInt(offset + 6));
