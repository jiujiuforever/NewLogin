...
public class GroupEntity extends PeerEntity {
    ...
    public GroupEntity(Long id, int peerId, int groupType, String mainName, String avatar, int creatorId, int userCnt, String userList, int version, int status, int statuValue, int created, int updated) {
        this.id = id;
        this.peerId = peerId;
    ...
    public int getStatuValue() {
        return statuValue;
    }
    public void setStatuValue(int statuValue) {
        this.statuValue = statuValue;
    }
